...
class ActiveRecord{
    ...
    public function crear(){
        ...
        if($resultado){
            header('Location: /admin/' . static::$tabla . '/visualizar.php?resultado=1');
        }
    }
    ...
    public function actualizar(){
        ...
        if($resultado){
            header('Location: /admin/' . static::$tabla . '/visualizar.php?resultado=2');
        }
    }
    ...
    public function eliminar() {
        ...
        if($resultado) {
            $this->borrarImagen();
            header('location: /admin/' . static::$tabla . '/visualizar.php?resultado=3');
        }
    }
